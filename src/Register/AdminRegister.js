...
function AdminRegister() {
  ...
  return (
    <div className="admin-register">
      ...
      <h1 className="admin-register__container__heading">ADMIN</h1>
        <input
          type="text"
          className="admin-register__textBox"
          value={name}
        ...
        />
        <button className="admin-register__btn" onClick={register}>
          Register
        </button>
        <button
          className="admin-register__btn admin-register__google"
